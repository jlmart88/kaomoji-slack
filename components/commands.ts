...
function getShortcutsUsageText() {
  return (
    ...
    KAOMOJI_SLASH +
    " " +
    COMMAND_LIST.SHORTCUTS +
    "` or `" +
    KAOMOJI_SLASH +
    "` to display/manage your shortcuts."
  );
}
...
function getHelpText() {
  const helpText =
    ...
    "`" +
    KAOMOJI_SLASH +
    ' table` - returns a list of kaomojis matching the search "table"' +
    "\n" +
    "`" +
    KAOMOJI_SLASH +
    " " +
    ...
    "` or `" +
    KAOMOJI_SLASH +
    "` - allows you to send/manage your shortcuts" +
    "\n" +
    "`" +
    KAOMOJI_SLASH +
    " " +
    COMMAND_LIST.LIST +
    "` - opens a search over all available kaomojis" +
    "\n" +
    "";
  return helpText;
}
...
function getNoUserTokenText(serverUrl: string) {
  return (
    "You must <" +
    serverUrl +
    "/oauth/signin|Sign in with Slack> to use the " +
    KAOMOJI_SLASH +
    " slash command. " +
    "If this is not working for you, check our <" +
    serverUrl +
    "/faq|FAQ> for further help."
  );
}
